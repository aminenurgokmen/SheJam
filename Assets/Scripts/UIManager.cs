...
public class UIManager : MonoBehaviour
{
    ...
    private string[] dialogLines =
    {
        ...
        "My head… my memories were buried with it beneath the earth. Bring it back, Shaman… I want to remember who I am.",
        "Without my eyes, all I saw was darkness.Now I want to see, Shaman… the world, you… and the truth.",
        "Thank you darling!"
    };
